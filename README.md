These are computations to accompany the paper "Secant varieties of Segre-Veronese varieties $\mathbb P^m\times\mathbb P^n$ embedded by $\mathcal O(1,2)$ are non-defective for $n\gg m^3$, $m\geq3$" ([M. Doležálek and N. Ken, J. Symbolic Comput. 135 (2026), 102546](https://doi.org/10.1016/j.jsc.2025.102546), [arXiv:2503.21972](https://arxiv.org/abs/2503.21972)), written as part of the [TENORS network](https://github.com/tenors-network).
